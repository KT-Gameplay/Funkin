...
class FocusCameraSongEvent extends SongEvent
{
  ...
  static final DEFAULT_UNIT:String = 'steps';
  ...
  public override function handleEvent(data:SongEventData):Void
  {
    ...
    var units:Null<String> = data.getString('units');
    if (units == null) units = DEFAULT_UNIT;
    ...
    switch (ease)
    {
      ...
      default:
        var durSeconds = (units == 'steps') ? Conductor.instance.stepLengthMs * duration / 1000 : duration; // Switches to the selected unit.
